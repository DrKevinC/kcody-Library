    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id">
          <span v-if="author.name == 'George Orwell'" :class="{ active: isActive }" :style="{ color: textColor, fontSize: fontSize + 'px'}">{{  author.name }}</span>
      ...
      <p>Finding by property: <span :class="{ active: isActive }" :style="{ color: textColor, fontSize: fontSize + 'px'}">{{ orwell[0].name }}</span></p>
    ...
    <section class="lab-section">
      ...
      <p>
        ...
        <!-- TODO: CODE TO GET TOTAL STORES HERE -->
         {{ bookstores.storeTypes.physical + bookstores.storeTypes.online }}
      </p>
      ...
      <ul>
        <li v-for="num, storeType in bookstores.storeTypes" :key="storeType">
          {{ storeType }}: {{ num }}
        </li>
      </ul>
      ...
      <ul>
        <li v-for="times, hours in bookstores.openingHours" :key="hours">
          {{ hours }}: {{ times.open }} - {{ times.close }}
        </li>
      </ul>
